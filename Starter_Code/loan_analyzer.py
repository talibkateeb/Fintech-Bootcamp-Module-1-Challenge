...
print(f"The number of remaining months to for this loan is {remaining_months}")
...
present_value = present_value_calculator(new_loan.get("future_value"), new_loan.get("remaining_months"), annual_discount_rate)
